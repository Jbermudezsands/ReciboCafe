Public Class FrmResumenLiquidacion
    ...
    Private Sub FrmPendientesLiquid_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If UsuarioType = "AutorizaPrecioFueraDiscrecionalidad" Then  ' UsuarioType = "AutorizaPrecioDiscrecionalidad" Or
            sql = "SELECT DISTINCT  TipoIngreso.Descripcion, LiquidacionPergamino.Codigo, LiquidacionPergamino.Serie, LiquidacionPergamino.NumeroReembolso, LiquidacionPergamino.Fecha, Calidad.NomCalidad,  SUM(DetalleLiquidacionPergamino.PesoNeto) AS Cantidad, EstadoDocumento.Descripcion AS Estado, Proveedor.Cod_Proveedor, Proveedor.Nombre_Proveedor + ' ' + Proveedor.Apellido_Proveedor AS NombreProveedor,   LiquidacionPergamino.IdLiquidacionPergamino, SUM(LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto) AS ValorBruto, LiquidacionPergamino.TotalDeducciones, SUM(LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto - LiquidacionPergamino.TotalDeducciones) AS PesoNeto,     SUM(LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto / TipoCambio.TipoCambio) AS ValorDolares, SUM(LiquidacionPergamino.TotalDeducciones / TipoCambio.TipoCambio) AS DeduccionesDol,    SUM((LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto - LiquidacionPergamino.TotalDeducciones) / TipoCambio.TipoCambio) AS PesoNetoDol FROM   LiquidacionPergamino INNER JOIN     TipoIngreso ON LiquidacionPergamino.IdTipoIngreso = TipoIngreso.IdECS INNER JOIN                          DetalleLiquidacionPergamino ON LiquidacionPergamino.IdLiquidacionPergamino = DetalleLiquidacionPergamino.IdLiquidacionPergamino INNER JOIN                          ReciboCafePergamino ON DetalleLiquidacionPergamino.IdReciboPergamino = ReciboCafePergamino.IdReciboPergamino INNER JOIN                          Calidad ON ReciboCafePergamino.IdCalidad = Calidad.IdCalidad INNER JOIN                          EstadoDocumento ON LiquidacionPergamino.IdEstadoDocumento = EstadoDocumento.IdEstadoDocumento INNER JOIN                          Proveedor ON LiquidacionPergamino.Cod_Proveedor = Proveedor.IdProductor INNER JOIN                          TipoCambio ON LiquidacionPergamino.IdTipoCambio = TipoCambio.IdTipoCambio GROUP BY TipoIngreso.Descripcion, LiquidacionPergamino.Codigo, LiquidacionPergamino.NumeroReembolso, LiquidacionPergamino.Fecha, Calidad.NomCalidad, EstadoDocumento.Descripcion, LiquidacionPergamino.Cod_Proveedor,                           Proveedor.Nombre_Proveedor + ' ' + Proveedor.Apellido_Proveedor, LiquidacionPergamino.IdLiquidacionPergamino, Proveedor.Cod_Proveedor, LiquidacionPergamino.Precio, LiquidacionPergamino.TotalDeducciones,                           TipoCambio.TipoCambio, LiquidacionPergamino.Serie ORDER BY LiquidacionPergamino.Fecha DESC  "
        Else
            sql = "SELECT DISTINCT TipoIngreso.Descripcion, LiquidacionPergamino.Codigo, LiquidacionPergamino.Serie, LiquidacionPergamino.NumeroReembolso, LiquidacionPergamino.Fecha, Calidad.NomCalidad, SUM(DetalleLiquidacionPergamino.PesoNeto) AS Cantidad, EstadoDocumento.Descripcion AS Estado, Proveedor.Cod_Proveedor, Proveedor.Nombre_Proveedor + ' ' + Proveedor.Apellido_Proveedor AS NombreProveedor, LiquidacionPergamino.IdLiquidacionPergamino, SUM(LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto) AS ValorBruto, LiquidacionPergamino.TotalDeducciones,  SUM(LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto - LiquidacionPergamino.TotalDeducciones) AS PesoNeto, SUM(LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto / TipoCambio.TipoCambio) AS ValorDolares, SUM(LiquidacionPergamino.TotalDeducciones / TipoCambio.TipoCambio) AS DeduccionesDol, SUM((LiquidacionPergamino.Precio * DetalleLiquidacionPergamino.PesoNeto - LiquidacionPergamino.TotalDeducciones) / TipoCambio.TipoCambio) AS PesoNetoDol,  LiquidacionPergamino.IdLocalidad, LugarAcopio.IdLugarAcopio, LugarAcopio.IdRegion FROM LiquidacionPergamino INNER JOIN  TipoIngreso ON LiquidacionPergamino.IdTipoIngreso = TipoIngreso.IdECS INNER JOIN  DetalleLiquidacionPergamino ON LiquidacionPergamino.IdLiquidacionPergamino = DetalleLiquidacionPergamino.IdLiquidacionPergamino INNER JOIN ReciboCafePergamino ON DetalleLiquidacionPergamino.IdReciboPergamino = ReciboCafePergamino.IdReciboPergamino INNER JOIN  Calidad ON ReciboCafePergamino.IdCalidad = Calidad.IdCalidad INNER JOIN  EstadoDocumento ON LiquidacionPergamino.IdEstadoDocumento = EstadoDocumento.IdEstadoDocumento INNER JOIN  Proveedor ON LiquidacionPergamino.Cod_Proveedor = Proveedor.IdProductor INNER JOIN  TipoCambio ON LiquidacionPergamino.IdTipoCambio = TipoCambio.IdTipoCambio INNER JOIN LugarAcopio ON LiquidacionPergamino.IdLocalidad = LugarAcopio.IdLugarAcopio GROUP BY TipoIngreso.Descripcion, LiquidacionPergamino.Codigo, LiquidacionPergamino.NumeroReembolso, LiquidacionPergamino.Fecha, Calidad.NomCalidad, EstadoDocumento.Descripcion, LiquidacionPergamino.Cod_Proveedor, Proveedor.Nombre_Proveedor + ' ' + Proveedor.Apellido_Proveedor, LiquidacionPergamino.IdLiquidacionPergamino, Proveedor.Cod_Proveedor, LiquidacionPergamino.Precio, LiquidacionPergamino.TotalDeducciones, TipoCambio.TipoCambio, LiquidacionPergamino.Serie, LiquidacionPergamino.IdLocalidad, LugarAcopio.IdLugarAcopio, LugarAcopio.IdRegion HAVING(LugarAcopio.IdRegion = " & IdRegionUsuario & ") ORDER BY LiquidacionPergamino.Fecha DESC"
