...
Partial Public Class ArepBitacoraLiquidacion 
    ...
    Private Sub InitializeComponent()
        ...
        Me.LblProductor.Top = 0.55!
        Me.LblProductor.Width = 2.125!
        '
        'LblIdentificacion
        '
        ...
        Me.SubReportDetalleRecibo.Top = 4.25!
