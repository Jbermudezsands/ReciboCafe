...
Public Class ArepReporteDetalleLiquidacion 
    Public IdLiquidacion As Double, IdLiquidaAnt As Double = 0
    Public MiConexion As New SqlClient.SqlConnection(Conexion), Registros As Double


    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Dim SqlString As String, DataSet As New DataSet, DataAdapter As New SqlClient.SqlDataAdapter, Monto As Double, Total As Double, PesoNeto As Double, TotalDeduccion As Double
        ...
        If Me.TxtIdLiquidacion.Text <> "" Then
            ...
            If DataSet.Tables("Consulta2").Rows.Count <> 0 Then
                ...
                TotalDeduccion = 0
                If Me.TxtIdLiquidacion.Text <> IdLiquidaAnt Then
                    IdLiquidaAnt = Me.TxtIdLiquidacion.Text
                    TotalDeduccion = DataSet.Tables("Consulta2").Rows(0)("TotalDeducciones")
                End If

                Total = Total - TotalDeduccion
