Public Class FrmQQ
    ...
    Private Sub C1Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles C1Button1.Click
        If Me.TxtQQ.Text = "" Then
            MsgBox("Es necesario Digitar una cantidad de sacos", MsgBoxStyle.Critical, "Sistema Bascula")
            Exit Sub
        ElseIf CDbl(Me.TxtQQ.Text) <= 0 Then
            MsgBox("La Cantidad de Sacos digitada tiene que ser mayor a Cero", MsgBoxStyle.Critical, "Sistema Bascula")
            Exit Sub
        Else
            QQ = Me.TxtQQ.Text
        End If
